...
FunctionsToExport = 'Get-Now', 'Get-Timestamp', 'Get-Today', 'Measure-Object_All', 
               'Measure-Object_AllStats', 'Measure-Object_Any', 
...
AliasesToExport = 'now', 'timestamp', 'today', 'all', 'stats', 'any', 'avg', 'chars', 'count', 
               'lines', 'max', 'min', 'stddev', 'sum', 'words', 'first', 'index', 'last', 'skip', 
               'skipindex', 'skiplast'
